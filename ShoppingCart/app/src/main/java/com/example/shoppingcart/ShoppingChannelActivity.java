    ...
    private void showGoods() {
        ...
        for (; i < goodsArray.size(); i++) {
            ...
            iv_thumb.setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(com.example.shoppingcart.ShoppingChannelActivity.this, ShoppingDetailActivity.class);
            ...
            btn_add.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Toast.makeText(com.example.shoppingcart.ShoppingChannelActivity.this,
