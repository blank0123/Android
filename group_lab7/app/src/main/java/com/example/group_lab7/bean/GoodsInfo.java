package com.example.group_lab7.bean;

import com.example.group_lab7.R;
...
public class GoodsInfo {
    ...
    public static ArrayList<GoodsInfo> getDefaultList() {
        ...
        for (int i = 0; i < listImageArray.length; i++) {
            listArray.add(new com.example.group_lab7.bean.GoodsInfo(listImageArray[i], listTitleArray[i], listDescArray[i]));
        }
        return listArray;
    }
    ...
    public static ArrayList<GoodsInfo> getDefaultGrid() {
        ...
        for (int i = 0; i < gridImageArray.length; i++) {
            gridArray.add(new com.example.group_lab7.bean.GoodsInfo(gridImageArray[i], gridTitleArray[i], null));
        }
        return gridArray;
    }
    ...
    public static ArrayList<GoodsInfo> getDefaultStag() {
        ...
        for (int i = 0; i < stagImageArray.length; i++) {
            stagArray.add(new com.example.group_lab7.bean.GoodsInfo(stagImageArray[i], stagTitleArray[i], null));
        }
        return stagArray;
    }
    ...
    public static ArrayList<GoodsInfo> getDefaultCombine() {
        ...
        for (int i = 0; i < combineImageArray.length; i++) {
            //TODO
            combineArray.add(new com.example.group_lab7.bean.GoodsInfo(combineImageArray[i], combineTitleArray[i], null));
        }
        return combineArray;
    }
    ...
    public static ArrayList<GoodsInfo> getDefaultAppi() {
        ...
        for (int i = 0; i < appiImageArray.length; i++) {
            appiArray.add(new com.example.group_lab7.bean.GoodsInfo(appiImageArray[i], appiTitleArray[i], null));
        }
        return appiArray;
    }
