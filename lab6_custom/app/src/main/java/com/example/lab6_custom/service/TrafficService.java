package com.example.lab6_custom.service;
...
import com.example.lab6_custom.MainActivity;
import com.example.lab6_custom.MainApplication;
import com.example.lab6_custom.R;
...
public class TrafficService extends Service {
    ...
    private void showFlowNotify(int layoutId, String desc, int progress) {
        ...
        builder.setContentIntent(clickIntent) // 设置内容的点击意图
                ...
                .setSmallIcon(R.mipmap.ic_launcher_round); // 设置状态栏里的小图标
        // 根据消息构造器构建一个通知对象
