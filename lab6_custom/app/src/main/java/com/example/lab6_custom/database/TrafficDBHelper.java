package com.example.lab6_custom.database;
...
public class TrafficDBHelper extends SQLiteOpenHelper {
    ...
    private static com.example.lab6_custom.database.TrafficDBHelper mHelper = null; // 数据库帮助器的实例
    ...
    // 利用单例模式获取数据库帮助器的唯一实例
    public static com.example.lab6_custom.database.TrafficDBHelper getInstance(Context context, int version) {
        if (version > 0 && mHelper == null) {
            mHelper = new com.example.lab6_custom.database.TrafficDBHelper(context, version);
        } else if (mHelper == null) {
            mHelper = new com.example.lab6_custom.database.TrafficDBHelper(context);
        }
        return mHelper;
    }
