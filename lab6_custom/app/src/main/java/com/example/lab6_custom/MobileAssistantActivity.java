...
import com.example.lab6_custom.adapter.TrafficInfoAdapter;
import com.example.lab6_custom.bean.AppInfo;
import com.example.lab6_custom.service.TrafficService;
import com.example.lab6_custom.util.AppUtil;
import com.example.lab6_custom.util.DateUtil;
import com.example.lab6_custom.util.SharedUtil;
import com.example.lab6_custom.util.StringUtil;
import com.example.lab6_custom.widget.CircleAnimation;
import com.example.lab6_custom.widget.CustomDateDialog;
import com.example.lab6_custom.widget.CustomDateDialog.OnDateSetListener;
import com.example.lab6_custom.widget.NoScrollListView;
...
public class MobileAssistantActivity extends Activity implements
    ...
    private void refreshTraffic(int day) {
        ...
        // 构建一个流量信息的列表适配器
        TrafficInfoAdapter adapter = new TrafficInfoAdapter(com.example.lab6_custom.MobileAssistantActivity.this, fullArray);
    ...
    private void showDayAnimation() {
        ...
        // 创建日流量的圆弧动画
        CircleAnimation dayAnimation = new CircleAnimation(com.example.lab6_custom.MobileAssistantActivity.this);
        // 设置日流量动画的四周边界
    ...
    private void showMonthAnimation() {
        ...
        // 创建月流量的圆弧动画
        CircleAnimation monthAnimation = new CircleAnimation(com.example.lab6_custom.MobileAssistantActivity.this);
        // 设置月流量动画的四周边界
