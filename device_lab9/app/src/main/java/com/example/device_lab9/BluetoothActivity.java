...
import com.example.device_lab9.adapter.BlueListAdapter;
import com.example.device_lab9.bean.BlueDevice;
import com.example.device_lab9.util.BluetoothUtil;
...
public class BluetoothActivity extends AppCompatActivity implements
    ...
    private Runnable mDiscoverable = new Runnable() {
        public void run() {
            ...
            if (BluetoothUtil.getBlueToothStatus(com.example.device_lab9.BluetoothActivity.this)) {
                // 弹出是否允许扫描蓝牙设备的选择对话框
