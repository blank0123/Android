...
//              setResult(RESULT_CANCELED, intent);
		...
		resetButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				RadioButton r1 = (RadioButton)findViewById(R.id.statusNotDone);
				r1.setChecked(true);
				RadioButton r2 = (RadioButton)findViewById(R.id.medPriority);
				r2.setChecked(true);
...
//可以          String titleString = mTitleText.getText().toString();
