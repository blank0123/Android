...
public class CalendarFragment extends Fragment {
    ...
    // 获取该碎片的一个实例
    public static com.example.lab5.fragment.CalendarFragment newInstance(int year, int month) {
        com.example.lab5.fragment.CalendarFragment fragment = new com.example.lab5.fragment.CalendarFragment(); // 创建该碎片的一个实例
